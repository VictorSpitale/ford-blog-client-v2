...
const PasswordRecoveryModal = ({isShowing, toggle}: PropsType) => {
    ...
    return (
        <Modal isShowing={isShowing} hide={toggle}>
            <div data-content={"pr-modal"} className={"p-5 pt-0"}>
                ...
                {!sent ?
                    <div className={"flex items-end flex-col"}>
                        ...
                        <InputField value={email} name={"email"} onChange={(e) => setEmail(e.target.value)}
                                    label={t.login.email} />
