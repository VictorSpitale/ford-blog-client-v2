...
const Edit = ({callback, large = true}: { callback?: AnyFunction, large?: boolean }) => {
    return (
        <svg data-content={"edit"} style={{cursor: "pointer"}} onClick={callback} xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 40 40"
